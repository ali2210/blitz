...
function GlobalStyles(props) {
  ...
  const globalStyles = typeof styles === "function" ? (themeInput) => styles(isEmpty(themeInput) ? defaultTheme7 : themeInput) : styles;
...
function createBox(options = {}) {
  ...
  const Box3 = React20.forwardRef(function Box4(inProps, ref) {
...
var _excluded16 = ["colorSchemes", "cssVarPrefix", "shouldSkipGeneratingVar"];
